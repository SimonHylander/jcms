...
import com.shy.jcms.domain.Authority;
import com.shy.jcms.domain.User;
import com.shy.jcms.repository.AuthorityRepository;
import com.shy.jcms.repository.UserRepository;
import com.shy.jcms.security.AuthoritiesConstants;
import com.shy.jcms.service.MailService;
import com.shy.jcms.service.UserService;
import com.shy.jcms.web.rest.dto.UserDTO;
...
public class AccountResourceIntTest {
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        UserDTO dup = new UserDTO(new Long(1), u.getLogin(), u.getPassword(), u.getLogin(), u.getLastName(),
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        UserDTO dup = new UserDTO(new Long(1), "johnjr", u.getPassword(), u.getLogin(), u.getLastName(),
